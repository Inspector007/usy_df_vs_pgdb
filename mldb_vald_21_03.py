...
def mldb_load_staging():
	...
	engine = create_engine(f'postgresql+psycopg2://{db_user_production}:{db_pass_production}@atomclient.westcentralus.cloudapp.azure.com:5432/ibm_atombridge_db?sslmode=', client_encoding='utf8' )
...
def init_conn():
	...
	try:
		...
		params_init_conn["engine_staging"] = create_engine(f'postgresql+psycopg2://{db_user_production}:{db_pass_production}@atomclient.westcentralus.cloudapp.azure.com:5432/ibm_atombridge_db?sslmode=', client_encoding='utf8' )
		...
		params_init_conn["connection_staging"] = params_init_conn["engine_staging"].raw_connection() 
		connection_staging = params_init_conn["connection_staging"]
		params_init_conn["cursor_staging"] = connection_staging.cursor()
		tbl_name_cndb = 'tbl_bridge_ibm_cndb_staging'
		
		#tbl_golden_master = 'tbl_golden_m'

		###tbl_fail = 'tbl_ibm_source_data_failures_staging'
		engine_prod_failure = create_engine(f'postgresql+psycopg2://{db_user_production}:{db_pass_production}@atomclient.westcentralus.cloudapp.azure.com:5432/ibm_atombridge_db?sslmode=', client_encoding='utf8' )
		...
		params_init_conn["engine_production_golden"] = create_engine(f'postgresql+psycopg2://{db_user_production}:{db_pass_production}@atomclient.westcentralus.cloudapp.azure.com:5432/ey_atombase_db?sslmode=', client_encoding='utf8' )
		engine_prod_ibm_atomdeployment_db = create_engine(f'postgresql+psycopg2://{db_user_production}:{db_pass_production}@atomclient.westcentralus.cloudapp.azure.com:5432/ibm_atomdeployment_db?sslmode=', client_encoding='utf8' )
		...
		#---err_init_conn------ 'connection_staging'
...
# -- Table: public.tbl_it_asset_baseline

# -- DROP TABLE public.tbl_it_asset_baseline;

# CREATE TABLE public.tbl_it_asset_baseline
# (
...
#     "BoTInstalled" boolean NOT NULL,
#     "ITTags" jsonb,
#     "BoTCommDate" timestamp without time zone,
#     "AdhocScan" boolean NOT NULL,
#     "AssetStatus" text COLLATE pg_catalog."default",
#     "AssetLocation" jsonb,
#     "AccountNumber" integer NOT NULL,
#     "AccountName" text COLLATE pg_catalog."default",
#     "SupportingTags" jsonb,
#     CONSTRAINT "PK_tbl_it_asset_baseline" PRIMARY KEY ("Id")
# )

# TABLESPACE pg_default;

# ALTER TABLE public.tbl_it_asset_baseline
#     OWNER to postgres;
# -- Index: index_it_asset_baseline

# -- DROP INDEX public.index_it_asset_baseline;

# CREATE INDEX index_it_asset_baseline
#     ON public.tbl_it_asset_baseline USING btree
#     ("Id" ASC NULLS LAST, "UpdatedOn" ASC NULLS LAST, "HostName" COLLATE pg_catalog."default" ASC NULLS LAST, "MacAddress" COLLATE pg_catalog."default" ASC NULLS LAST, "BoTInstalled" ASC NULLS LAST, "BoTCommDate" ASC NULLS LAST)
#     TABLESPACE pg_default;

# -- Trigger: trigger_tbl_itasset_baseline_update_audit_trail

# -- DROP TRIGGER trigger_tbl_itasset_baseline_update_audit_trail ON public.tbl_it_asset_baseline;

# CREATE TRIGGER trigger_tbl_itasset_baseline_update_audit_trail
#     AFTER INSERT OR UPDATE 
#     ON public.tbl_it_asset_baseline
#     FOR EACH ROW
#     EXECUTE PROCEDURE public.trigger_func_save_audit_trail();




# ------df_golden_m-------    GoldenValue
# 0           DR
# 1      DR-COLD
# 2       DR-HOT
# 3  Development
